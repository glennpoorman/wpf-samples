...
namespace TypedDataTemplates
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void AddBrownieClick(object sender, RoutedEventArgs e)
        {
            Scouts.Add(new Brownie() { Name = "New Brownie" });
            _ = CollectionViewSource.GetDefaultView(Scouts).MoveCurrentToLast();
        }

        /// <summary>
        /// Click event handler for the "Add Junior" menu item.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An object containing the event data.</param>
        private void AddJuniorClick(object sender, RoutedEventArgs e)
        {
            Scouts.Add(new Junior() { Name = "New Junior" });
            _ = CollectionViewSource.GetDefaultView(Scouts).MoveCurrentToLast();
        }

        /// <summary>
        /// Click event handler for the "Add Senior" menu item.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">An object containing the event data.</param>
        private void AddSeniorClick(object sender, RoutedEventArgs e)
        {
            Scouts.Add(new Senior() { Name = "New Senior" });
            _ = CollectionViewSource.GetDefaultView(Scouts).MoveCurrentToLast();
        }
