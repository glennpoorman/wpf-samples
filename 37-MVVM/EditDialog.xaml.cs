...
namespace MVVM
{
    ...
    public partial class EditDialog : Window
    {
        ...
        public EditDialog(Window owner, ScoutViewModel scout)
        {
            ...
            //
            // Note that we don't use a lambda expression for the dialog closure as we want to
            // remove the action from the view model event when we close and C# doesn't allow
            // for the removal of handlers that were added using lambda expressions.
            //
